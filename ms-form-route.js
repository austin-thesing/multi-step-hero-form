document.querySelector("[data-form='submit-btn']").addEventListener("click", function (event) {
  ...
  if (selectedOption === "is-apply") {
    ...
    successMessageElement.innerHTML =
      'Each and every business matters to us, and we\'re eager to hear more about yours. <br>In 5 seconds, you will be redirected to <a class="desktop-p2" href="https://app.onrampfunds.com/pre-approval">https://app.onrampfunds.com/pre-approval</a></br>Where you can get your no commitment, pre-approval offer.';
